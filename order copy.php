...
if ($_SERVER["REQUEST_METHOD"] === "POST" && isset($_POST['order'])) {
    if (!empty($_POST['food_drink']) && is_array($_POST['food_drink'])) {
        ...
        while ($item = $result->fetch_assoc()) {
            ...
            // Track maximum cooking time
            $max_cooking_time = max($max_cooking_time, $item['cooking_time']);
        ...
        if (!empty($items)) {
            ...
            $stmt_order->bind_param("sssi", $items_str, $ingredients1_str, $ingredients2_str, $max_cooking_time);
            ...
            if ($stmt_order->execute()) {
                ...
                $_SESSION['estimated_cooking_time'] = $max_cooking_time;
                $_SESSION['order_start_time'] = time();
                ...
                $game_url = "1-player.html?cookingTime=" . ($max_cooking_time * 60);
...
<footer class="site-footer">
    <div class="footer-content">
        ...
        <p class="copyright">Developed with ❤️ by <a href="https://neuovacoders.com" target="_blank">Neuova Coders</a></p>
    </div>
</footer>
    <script>
        ...
        function startTimer() {
            ...
            function updateTimer() {
                ...
                if (remaining <= 60) { // Last minute
                    ...
                    progressBar.style.background = 'linear-gradient(to right, #ff0000, #ff6b6b)';
                } else {
                    timerDisplay.classList.remove('timer-warning');
                    progressBar.style.background = 'linear-gradient(to right, var(--secondary), var(--accent))';
                }
        ...
        document.querySelectorAll('.place-order-btn').forEach(btn => {
            btn.addEventListener('click', function() {
                ...
                checkedItems.forEach(checkbox => {
                    ...
                    itemsSummary.push(`${checkbox.value} (x${quantity}) - ${(price * quantity).toFixed(2)} ETB (${cookingTime} min)`);
                });
                ...
                Swal.fire({
                    ...
                    html: `
                        <div style="text-align: left;">
                            ...
                            <p>Estimated cooking time: <b>${maxCookingTime} minutes</b></p>
