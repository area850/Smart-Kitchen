...
if ($conn->connect_error) {
    ...
    if (isset($_GET['search'])) {
        ...
        if (!empty($search)) {
            $where_clause .= " AND (items LIKE '%$search%' OR ing_1 LIKE '%$search%' OR ing_2 LIKE '%$search%')";
        }
    }
...
<body>
                        ...
                        <div class="order-body">
                            <div class="order-items">
                                <div class="order-item">
                                    ...
                                    // Display items with combined quantities
                                    foreach ($itemCounts as $itemName => $totalQuantity) {
                                        echo htmlspecialchars($itemName) . ' <span class="order-quantity">x(' . $totalQuantity . ')</span><br>';
                                    }
                                    ?>
    ...
    <script>
        ...
        function checkEmptyOrders() {
            ...
            if (ordersGrid.querySelectorAll('.order-card').length === 0) {
